                ...
                <div class="card-body">
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">{{ $patient->dni }}</div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Edad</div>
                            <div class="text-gray-600">{{ $patient->age }} años</div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Fecha de Nacimiento</div>
                            <div class="text-gray-600">{{ \Carbon\Carbon::parse($patient->born_date)->format('d-m-Y') }}</div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Aseguradoras</div>
                            <div class="text-gray-600">{{ $patient->insurance_companies }}</div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Correo</div>
                            <div class="text-gray-600">
                                <a href="mailto:{{ $patient->email }}" class="text-gray-600 text-hover-primary">{{$patient->email}}</a>
                            </div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Telefono</div>
                            <div class="text-gray-600">{{ $patient->phone }}</div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Direccion</div>
                            <div class="text-gray-600">{{ $patient->address }}</div>
                        </div>
                    </div>
                    <!--end::Details content-->
                </div>
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title">
                            <h2 class="d-flex align-items-center">Reclamos
                                <span class="text-gray-600 fs-6 ms-1">({{ $patient->count() }})</span>
                            </h2>
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
