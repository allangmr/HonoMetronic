<x-default-layout>
    @section('title')
    {{ $patient->name }} - Información del Paciente
    @endsection
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $patient->name }}</a>
                        <!--end::Name-->
                        <!--begin::Info-->
                        <!--begin::Info heading-->
            ...
            <div class="d-flex justify-content-end mb-5">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                    ...
                    <div class="menu-item px-5">
                        <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">Opciones</div>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <span class="menu-item px-5" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Editar Paciente">
                        <a href="#" class="menu-link px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">Editar</a>
                    </span>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <span class="menu-item px-5" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Elimar Paciente">
                        <a href="#" class="menu-link px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">Eliminar</a>
                    </span>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
