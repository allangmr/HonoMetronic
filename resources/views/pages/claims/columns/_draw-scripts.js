...
document
    ...
    .forEach(function (element) {
        element.addEventListener("click", function () {
            Swal.fire({
                text: "Esta seguro que desea eliminar este Reclamo?",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    Livewire.emit(
                        "delete_claim",
                        this.getAttribute("data-kt-claim-id")
                    );
                }
            });
        });
...
Livewire.on("success", (message) => {
    ...
    LaravelDataTables["claims-table"].ajax.reload();
});
