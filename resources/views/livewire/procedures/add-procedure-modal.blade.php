<div class="modal fade" id="kt_modal_add_procedure" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_add_procedure_header">
                <!--begin::Modal title-->
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_procedure_form" class="form" action="#" wire:submit.prevent="submit" enctype="multipart/form-data">
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_procedure_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_procedure_header" data-kt-scroll-wrappers="#kt_modal_add_procedure_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            @if($code || $submitButtonTitle === '' )
                            <input type="text" wire:model.defer="code" name="code" class="form-control form-control-solid mb-3 mb-lg-0" disabled />
                            @else
                            <input type="text" wire:model.defer="code" name="code" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Codigo" />
                            @endif
                            <!--end::Input-->
                            @error('code')
                            <span class="text-danger">{{ $message }}</span> @enderror
                    ...
                    <div class="text-center pt-15">
                        ...
                        @if($submitButtonTitle)
                        <button type="submit" class="btn btn-primary" data-kt-procedures-modal-action="submit">
